...
public class ConexionLocal {
	...
	public ResultSet consultaSedes(){
		String query = "SELECT DISTINCT UZGTPERSON_SEDE_CODE AS CODIGO, UZGTPERSON_SEDE FROM UZGTPERSON";
	...
	public ResultSet consultaUnidades(String sedeCode){
		String query = "SELECT DISTINCT UZGTPERSON_UNIDAD AS UNIDAD FROM UZGTPERSON WHERE UZGTPERSON_SEDE_CODE='"+sedeCode+"'";
	...
	public ResultSet consultaPorId(String valorId){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE PK_UZGTPERSON_ID='"+valorId+"'";
	...
	public ResultSet consultaPorNombre(String valorTexto){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE UZGTPERSON_NOMBRE LIKE'%"+valorTexto+"%' ";
	...
	public ResultSet consultaPorTelefono(String valorTexto){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE UZGTTELE_NUM_TELEFONO LIKE'%"+valorTexto+"%' ";
	...
	public ResultSet consultaPorExtension(String valorTexto){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE UZGTEXTE_NUM_EXTENSION LIKE'%"+valorTexto+"%' ";
	...
	public ResultSet consultaPorIdAsignado(VistaBusqueda datoDelete){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE PK_UZGTEXTE_ID="+datoDelete.getIdAsignacion()+"";
	...
	public ResultSet consultaPorSedeUnidad(String codeSede, String codeUnidad, String valorTexto){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE UZGTPERSON_SEDE_CODE='"+codeSede+"' AND UZGTPERSON_UNIDAD='"+codeUnidad+"' AND UZGTPERSON_NOMBRE LIKE'%"+valorTexto+"%' ";
	...
	public ResultSet consultaPorSedeTodos(String codeSede, String valorTexto){
		String query = "SELECT * FROM VW_UZGTGUIA WHERE UZGTPERSON_SEDE_CODE='"+codeSede+"' AND UZGTPERSON_NOMBRE LIKE'%"+valorTexto+"%' ";
	...
	public ResultSet consultaFindPersonal(Personal personal){
		String query = "SELECT PK_UZGTPERSON_ID AS IDPERSONAL FROM UZGTPERSON WHERE PK_UZGTPERSON_ID='"+personal.getIdDocente()+"'";
	...
	public ResultSet consultaFindRelacion(VistaBusqueda personal){
		String query = "SELECT PK_UZGTPERSON_ID AS IDRELACION FROM UZGTEXTE_UZGTPERSON WHERE PK_UZGTPERSON_ID='"+personal.getIdPersonal()+"'";
	...
	/*
	 * MetodoS para guardar una nueva extension.
	 * */
	public int guardarPersonal(Personal personal){
		String query = "insert into UZGTPERSON(PK_UZGTPERSON_ID,UZGTPERSON_NOMBRE,UZGTPERSON_PUEST,UZGTPERSON_UNIDAD,UZGTPERSON_DIREC,UZGTPERSON_CIUDAD,UZGTPERSON_CORR,UZGTPERSON_SEDE,UZGTPERSON_SEDE_CODE) "
				+ "values('"+personal.getIdDocente()+"','"+personal.getNombres()+"','"+personal.getPuesto()+"','"+personal.getUnidad()+"','"+personal.getDirecInstitu()+"','"+personal.getCiudadLabora()+"','"+personal.getCorreo()+"','"+personal.getSede()+"','"+personal.getSedeCode()+"')";
	...
	public int guardarTelefono(String telefono){
		String query = "insert into UZGTTELE(PK_UZGTTELE_ID,UZGTTELE_NUM_TELEFONO) values(IN_TELE.nextval,'"+telefono+"')";
	...
	public int guardarExtension(String exte,long idTelefono){
		String query = "insert into UZGTEXTE(PK_UZGTEXTE_ID,PK_UZGTTELE_ID,UZGTEXTE_NUM_EXTENSION,UZGTEXTE_ESTADO) values(IN_EXT.nextval,"+idTelefono+",'"+exte+"',1)";
	...
	public int guardarRelPersonaExt(Personal persona,long exte){
		String query = "insert into UZGTEXTE_UZGTPERSON(PK_UZGTPERSON_ID,PK_UZGTEXTE_ID) values('"+persona.getIdDocente()+"',"+exte+")";
	...
	public int modificarTelefono(long idAsignado,String nuevoFono){
		String query = "Update UZGTTELE set UZGTTELE_NUM_TELEFONO='"+nuevoFono+"' where PK_UZGTTELE_ID="+idAsignado+"";
	...
	public int modificarExtension(long idAsignado,String nuevaExten){
		String query = "Update UZGTEXTE set UZGTEXTE_NUM_EXTENSION='"+nuevaExten+"' where PK_UZGTEXTE_ID="+idAsignado+"";
	...
	public int eliminarRelacion(VistaBusqueda eliminar){
		String query = "DELETE FROM UZGTEXTE_UZGTPERSON WHERE PK_UZGTEXTE_ID="+eliminar.getIdAsignacion()+"";
	...
	public int eliminarExtension(VistaBusqueda eliminar){
		String query = "DELETE FROM UZGTEXTE WHERE PK_UZGTEXTE_ID="+eliminar.getIdAsignacion()+"";
	...
	public int eliminarTelefono(VistaBusqueda eliminar){
		String query = "DELETE FROM UZGTTELE WHERE PK_UZGTTELE_ID="+eliminar.getIdAsignacion()+"";
	...
	public int eliminarIdPersonal(VistaBusqueda eliminar){
		String query = "DELETE FROM UZGTPERSON WHERE PK_UZGTPERSON_ID='"+eliminar.getIdPersonal()+"'";
